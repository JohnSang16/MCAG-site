const milestones = [
  {
    label: 'The Calling',
    description: "2021. Pastors Abraham and Sarah receive God's calling to start a new congregation.",
    icon: (
  ...
  },
  {
    ...
    description: '2021. The church holds its first service from the family home in Clarkston, GA.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
